const KEYWORD_MAP = [
  // ── Espresso ──
  [['espresso', 'shot', 'ristretto', 'doble', 'concentrado'], 'photo-1509042239860-f550ce710b93'],
  // ── Café frío / cold brew (ANTES del genérico café) ──
  [['cold brew', 'cold-brew', 'café frío', 'cafe frio', 'frío', 'frio', 'hielo'],
    'photo-1517959105821-ecd7a1a41ca5'],
  // ── Frappé ──
  [['frappé', 'frappe', 'frapé', 'caramelo'],  'photo-1461023058943-07fcbe16d735'],
  // ── Americano ──
  [['americano'],  'photo-1521302200778-33500795e128'],
  // ── Latte / flat white ──
  [['latte', 'flat white', 'vaporizada'],  'photo-1561882468-9110e03e0f78'],
  // ── Cappuccino ──
  [['cappuccino', 'capuccino', 'espuma'],  'photo-1572442388796-11668a67e53d'],
  // ── Mocha ──
  [['mocha', 'moka', 'mocca'],  'photo-1578374173705-969cbe6f2d6b'],
  // ── Macchiato ──
  [['macchiato'],  'photo-1485808191679-5f86510bd5b8'],
  // ── Té verde / matcha (ANTES del genérico té) ──
  [['matcha', 'té verde', 'te verde', 'verde'],  'photo-1536256263959-770b48d82b0a'],
  // ── Té / chai ──
  [['té', 'te', 'tea', 'chai', 'miel'],  'photo-1556679343-c7306c1976bc'],
  // ── Chocolate caliente / cacao (ANTES del genérico chocolate) ──
  [['chocolate caliente', 'cacao', 'artesanal'],  'photo-1542990253-0d0f5be5f0ed'],
  // ── Agua ──
  [['agua', 'water', 'mineral', 'embotellada', 'natural'],  'photo-1559839914-17aae19cec71'],
  // ── Limonada ──
  ...
  // ── Genérico café (va AL FINAL entre los cafés) ──
  [['café', 'cafe', 'coffee'],  'photo-1495474472287-4d71bcdd2085'],
  // ── Croissant ──
  [['croissant', 'mantequilla'],  'photo-1555507036-ab1f4038808a'],
  // ── Muffin blueberry / arándano (ANTES del genérico muffin) ──
  [['blueberry', 'arándano', 'arandano'],  'photo-1607478900766-efe13248b125'],
  // ── Muffin chocolate (ANTES del genérico muffin) ──
  [['muffin chocolate', 'esponjoso'],  'photo-1578985545062-69928b1d9587'],
  ...
  // ── Pan de nuez ──
  [['pan de nuez', 'nuez', 'nueces', 'walnut'],  'photo-1549931319-a545dcf3bc73'],
  // ── Pan dulce / concha ──
  ...
  // ── Genérico pan (va al final) ──
  [['pan', 'baguette', 'barra'],  'photo-1509440159596-0249088772ff'],
  // ── Club sándwich (ANTES del genérico sándwich) ──
  [['club sándwich', 'club sandwich', 'triple piso', 'triple'],
    'photo-1567234669003-dce7a7a88821'],
  // ── Caprese (ANTES del genérico sándwich) ──
  [['caprese', 'mozzarella', 'jitomate', 'albahaca', 'ciabatta'],
    'photo-1604328698692-f76ea9498e76'],
  // ── Pollo BBQ ──
  [['pollo bbq', 'bbq', 'plancha', 'pollo'],  'photo-1598515214211-89d3c73ae83b'],
  // ── Jamón / ham ──
  [['jamón', 'jamon', 'ham'],  'photo-1528735602780-2552fd46c7af'],
  // ── Genérico sándwich / torta / wrap ──
